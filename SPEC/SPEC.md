...
| `telemetry.claude_code-policy` | Claude Code telemetry (logs+metrics+traces) | `telemetry.claude_code@lifecycle` | the 3 per-agent claude templates |

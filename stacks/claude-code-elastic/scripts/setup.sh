...
#   3. import the Kibana saved objects: the cross-agent backend data view, then
#      the Claude Code agent's data views / saved searches / dashboard
#
...
#
# Verification (smoke-test.sh) stays separate — this script only sets things up.
#

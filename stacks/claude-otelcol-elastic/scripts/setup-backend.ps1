...
& (Join-Path $ComponentsDir 'backends/elastic/scripts/setup-elasticsearch.ps1') -Sources 'claude' 6>&1 | Indent

Write-Host ''
Write-Host '[backend] 3/3 - Kibana saved objects'
& (Join-Path $ComponentsDir 'backends/elastic/scripts/setup-kibana.ps1') -Sources 'claude', 'otelcol-sidecar' 6>&1 | Indent

...
if (-not $Workbench) { [Console]::Error.WriteLine('FAIL: usage: verify-user-prompt-audit-claude.ps1 -Workbench <dir>  (or set AOL_WORKBENCH) — the directory agent config was placed into'); exit 1 }

...
config_place::place_file 'agent-audit' 'claude' "$marker_endpoint" "$tmp" "$config"
[ -n "$seal_recipients_src" ] &&
  config_place::place_file 'agent-audit' 'claude' "$marker_endpoint" "$seal_recipients_src" "$placed_cert"
config_place::place_self_ignore 'claude' "$marker_endpoint" "$target_dir/.claude"
